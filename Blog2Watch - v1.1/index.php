		        ...
		        <div class="modal-header">
		      	...
		      	<div class="modal-body bg-darkGray">
					...
					<div class="col-md-12 mb-2" >
						<div class="row g-2">
							<div class="col-6">
								<h5 class="float-end"><span class="float-end"><i class="fa-solid fa-message"></i></span><br><span class="float-end"><i class="fa-solid fa-mailbox"></i></span><br><i class="fa-solid fa-popcorn"></i><i class="fa-solid fa-popcorn"></i><i class="fa-solid fa-popcorn"></i><i class="fa-solid fa-popcorn"></i><i class="fa-solid fa-popcorn"></i></h5>
							</div>
							<div class="col-6">
								<h5>Comentar<br>Buzón<br>Reaccionar</h4>
							</div>
						</div>
					</div>
					<div class="col-md-12 mb-3 text-center">
						<p>Registrate o inicia sesión en nuestro blog</p>
						<button class="btn buttons-aviso"><a href="sign_up.php" class="text-white">Registrarse</a></button>
						<button class="btn buttons-aviso"><a href="login.php" class="text-white">Iniciar sesión</a></button>		
					</div>
		       	</div>
		    </div>
		  </div>
