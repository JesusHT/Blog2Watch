		...
		<content>
			<div class="container-fluid">
				<content class="row">
													...
													<div class="col-md-12">
														<div class="row">
															<form method="POST" class="btn-group mb-3" action="index-administrador.php">
																<input type="hidden" name="comentar" value="<?php echo $result -> id_post; ?>">
					...
					<div class="tab-pane fade" id="perfil" role="tabpanel" aria-labelledby="perfil-tab"><section class="col-md-8 position-center">aaaa</section></div>
					<div class="tab-pane fade" id="buzon" role="tabpanel" aria-labelledby="buzon-tab"><section class="col-md-8 position-center">aaaa</section></div>
				</content>
			</div>
		</content>
	</div>
